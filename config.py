...
class Config:
    ...
    MOBILE_ACCESS_TOKEN_TTL_SECONDS = int(os.getenv("MOBILE_ACCESS_TOKEN_TTL_SECONDS", "3600"))
    ...
    MOBILE_CHAT_REPLY_TIMEOUT_SECONDS = float(os.getenv("MOBILE_CHAT_REPLY_TIMEOUT_SECONDS", "60"))
